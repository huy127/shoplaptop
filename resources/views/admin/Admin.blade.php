...
<head>
    ...
    <link href="{{ asset('source/assets/dest/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet"
        type="text/css">
    <link
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Request::url() == route('quanlysanpham') ? 'active' : '' }}">
                <a class="nav-link collapsed" data-toggle="collapse" href="{{ route('quanlynguoidung') }}"
                ...
                <div id="collapsesp"
                    class="collapse
                @if (Session::get('gallery_session')) {{ Request::url() == route('quanlysanpham') || Request::url() == route('gallelyedit', Session::get('gallery_session')) ? 'show' : '' }}
                @else
                {{ Request::url() == route('quanlysanpham') ? 'show' : '' }} @endif"
                    aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">{{ trans('home_ad.ql_sp') }}:</h6>
                        <a class="collapse-item {{ Request::url() == route('quanlysanpham') ? 'active' : '' }}"
                            href="{{ route('quanlysanpham') }}">{{ trans('home_ad.allproduct') }}</a>
                        @if (Session::get('gallery_session'))
                            <a class="collapse-item {{ Request::url() == route('gallelyedit', Session::get('gallery_session')) ? 'active' : '' }}"
                                href="">{{ trans('home_ad.ql_gallery') }}
                                "{{ config('app.locale') == 'vi' ? $name_product->post->sp_vi : $name_product->post->sp_en }}"</a>
                        @endif
                    </div>
                </div>
            </li>
            ...
            <li class="@if (Request::url() == route('quanlynsx')) nav-item active  @else nav-item @endif">
                <a class="nav-link" href="{{ route('quanlynsx') }}" data-target="#collapseUtilities"
            ...
            <li
                class="
                @if (Request::url() == route('quanlynguoidung') ||
                    Request::url() == route('quanlynguoidung_user') ||
                    Request::url() == route('quanlynguoidung_ad')) nav-item active
                @else nav-item @endif">
                <a class="nav-link collapsed" data-toggle="collapse" href="{{ route('quanlynguoidung') }}"
                ...
                <div id="collapseUser"
                    class="
                        @if (Request::url() == route('quanlynguoidung') ||
                            Request::url() == route('quanlynguoidung_user') ||
                            Request::url() == route('quanlynguoidung_ad')) collapse show
                        @else collapse @endif"
                    aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @else collapse-item @endif"
                            href="{{ route('quanlynguoidung') }}">Tất Cả Tài Khoản
                        </a>
                        <a class="
                        @if (Request::url() == route('quanlynguoidung_user')) collapse-item active
                        @else collapse-item @endif"
                            href="{{ route('quanlynguoidung_user') }}">Tài Khoản Khách Hàng
                        </a>
                        <a class="
                        @if (Request::url() == route('quanlynguoidung_ad')) collapse-item active
                        @else collapse-item @endif"
                            href="{{ route('quanlynguoidung_ad') }}">
                            Tài Khoản Admin
                        </a>
                    </div>
            ...
            <li
                class="
                @if (Request::url() == route('donhang') ||
                    Request::url() == route('donhang_chuaduyet') ||
                    Request::url() == route('donhang_daduyet') ||
                    Request::url() == route('donhang_huy')) nav-item active
                @else nav-item @endif">
                ...
                <div id="collapseUtilities"
                    class="
                        @if (Request::url() == route('donhang') ||
                            Request::url() == route('donhang_chuaduyet') ||
                            Request::url() == route('donhang_daduyet') ||
                            Request::url() == route('donhang_huy')) collapse show
                        @else collapse @endif"
                    aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small"
                                placeholder="{{ trans('home.search') }}" aria-label="Search"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <span
                                    class="badge badge-danger badge-counter">{{ $dh_count_chuaduyet + $dh_count_huy }}+</span>
                            </a>
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center"
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">Bạn có {{ $dh_count_chuaduyet }} đơn hàng chưa
                                            duyệt!</span>
                                    </div>
                                </a>
                                @if ($dh_count_huy)
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ route('donhang_huy') }}">
                                        <div class="mr-3">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-0">
                                ...
                                <a class="dropdown-item d-flex align-items-center"
                                    href="{{ URL::asset('') }}language/en">
                                    <div class="dropdown-list-image mr-3">
                                        <img src="https://cdn.countryflags.com/thumbs/united-states-of-america/flag-400.png"
                                            width="16px" alt="">
                                    </div>
                                    <div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="https://i.pinimg.com/originals/9b/69/ac/9b69acfda6b057c79950d8103622b648.jpg">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="#" data-toggle="modal"
                                    data-target="#userUpdate_{{ Auth::user()->id }}">
                                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                                    {{ trans('home_ad.account_information') }}
                                </a>
    ...
    <div class="modal fade" id="userUpdate_{{ Auth::user()->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('userupdate1') }}" method="post">
                    ...
                    <input type="text" hidden class="col-sm-9 form-control" id="idUpdate_{{ Auth::user()->id }}"
                        name="idUpdate" value="{{ Auth::user()->id }}" />
                    <div class="modal-body">
                        <div class="form-group">
                            <label style="font-weight: bold; color: #000">{{ trans('home.fullname') }}*</label>
                            <input type="text" id="e_name_{{ Auth::user()->id }}" name="name"
                                class="form-control" value="{{ Auth::user()->full_name }}" />

                        </div>
                        <div class="form-group">
                            <label style="font-weight: bold; color: #000">{{ trans('home.ress') }}*</label>
                            <input type="text" id="e_adress_{{ Auth::user()->id }}" required name="adress"
                                class="form-control" value="{{ Auth::user()->address }}" />
                        </div>
                        <div class="form-group">
                            <label style="font-weight: bold; color: #000">Email</label>
                            <input type="text" id="e_email_{{ Auth::user()->id }}" required name="email"
                                class="form-control" value="{{ Auth::user()->email }}" />
                        </div>
                        <div class="form-group">
                            <label style="font-weight: bold; color: #000">{{ trans('home.phone') }}*</label>
                            <input type="text" id="e_phone_{{ Auth::user()->id }}" required name="phone"
                                class="form-control" value="{{ Auth::user()->phone }}" />
                        </div>
                        <div class="form-group">
                            <label style="font-weight: bold; color: #000">{{ trans('home.pass') }}*</label>
                            <input type="password" id="e_password_{{ Auth::user()->id }}" required name="password"
                                class="form-control" />
                        </div>
                        <div class="form-group">
                            <label style="font-weight: bold; color: #000">{{ trans('home.repassword') }}*</label>
                            <input type="password" id="e_re_password_{{ Auth::user()->id }}" required
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i
                                class="icofont icofont-eye-alt"></i>{{ trans('home.cancel') }}</button>
                        <button type="submit" class="btn btn-primary"><i
                                class="icofont icofont-check-circled"></i>{{ trans('home.up_date') }}</button>
                    </div>
                </form>
                <!-- form delete end -->
            </div>
    ...
    <!-- Logout Modal-->
    @extends('dk-dn-dx/dangxuat') @section('content-dx')
    @endsection
            ...
            $(document).ready(function() {
                ...
                function drawChart() {
                    ...
                    var data = google.visualization.arrayToDataTable([
                        ['Task', 'Hours per Day'],
                        ['{{ trans('home_ad.dash_sp') }}', <?php echo $sp_count; ?>],
                        ['{{ trans('home_ad.dash_dn') }}', <?php echo $dh_count; ?>],
                        ['{{ trans('home_ad.dash_kh') }}', <?php echo $nd_count; ?>],
                        ['{{ trans('home_ad.dash_nsx') }}', <?php echo $loai_count; ?>],
                        ['Slider', <?php echo $slide_count; ?>]
                    ]);
                ...
                var chart = new Morris.Bar({
                    ...
                    labels: ['{{ trans('home_ad.dash_dn') }}', '{{ trans('home_ad.doanhso') }}',
                        '{{ trans('home_ad.loinhuan') }}', '{{ trans('home_ad.soluong') }}'
                    ]
                });
    ...
    <script type="text/javascript">
        @if (session('thongbao'))
            ...
            toastr.success('{{ session('thongbao') }}', '{{ trans('home.Notification') }}', {
                timeOut: 7000
            });
        @endif
        @if ($errors->any())
            @foreach ($errors->all() as $err)
                ...
                toastr.error('{{ $err }}', '{{ trans('home.Notification') }}', {
                    timeOut: 7000
                });
            @endforeach
        @endif
