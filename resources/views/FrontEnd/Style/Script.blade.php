 ...
 <script type="text/javascript">
     ...
     @if (session('thongbaoloi'))
         ...
         toastr.error('{{ session('thongbaoloi') }}', '{{ trans('home.Notification') }}', {
             timeOut: 7000
         });
     @endif
     @if ($errors->any())
         ...
         if (localStorage.getItem('compare') != null) {
            ...
            <td class="product-description" id="del-td4` + id + `">
                <a class="compare-cart text-uppercase" href="` + url + `"> + {{ trans('home.addcart') }}</a>
                 ...
                 $('#td6').append(`                            
            <td class="product-description" id="del-td5` + id + `"><a style="cursor: pointer;" onclick="del_Compare(` +
                     id + `)"><i class="fa fa-trash-o"></i></a></td>`
                 );
                 $('#td7').append(`                            
            ...
            <tr id="del-tr` + id + `">
              <td style="vertical-align: middle;">` + name +
                     `</td>
              <td style="vertical-align: middle; text-align: center;"><img style="vertical-align: middle; width: 200px; height:145px" src="` +
                     image +
                     `" alt=""></td>
              <td style="vertical-align: middle; text-align: center;"><a style="cursor: pointer;" onclick="del_Compare(` +
                     id + `)"><i class="fa fa-trash-o"></i></a></td>
 ...
 <script type="text/javascript">
     ...
     function view() {
          ...
          <div style="width:226px;height:100%; float:left; margin-right:1%" class="single-product" id="del-ggg` + id + `">
            <div class="pro-img">
                <a href="` + url + `">
                  ...
                  <img style="height:100px" class="secondary-img" src="` + image + `" alt="single-product">
                </a>
        ...
        `);
                 ...
                 $('#sidbar_product').append('<div class="single-product" id="del_product' + id +
                     '"><div class="pro-img"><a href="' + url +
                     '"><img style="width:=100px" "height:100px" class="primary-img" src="' + image +
                     '" alt="single-product"></a></div><div class="pro-content"><div class="pro-info"><h4><a href="' +
                     url + '">' + name + '</a></h4><p><span class="price">' + price +
                     '</span></p></div><div class="pro-actions"><div class="actions-primary"><a href="' + url +
                     '" title="{{ trans('home.addcart') }}"> + {{ trans('home.addcart') }}</a></div><div class="actions-secondary"><a style="cursor: pointer;" onclick="del_wishList(' +
                     id + ')" title="Remove"><i class="fa fa-trash-o"></i></a></div></div></div></div>');

                 $('#product_wishlist').append('<tr id="delete_trall' + id + '"><td id="delete_trall1' + id +
                     '" class="product-remove"><a style="cursor: pointer;" onclick="del_wishList(' + id +
                     ')" title="Remove"><i class="fa fa-times" aria-hidden="true"></i></a></td><td id="delete_trall2' +
                     id + '" class="product-thumbnail"><a href="#"><img src="' + image +
                     '" alt="cart-image" /></a></td><td id="delete_trall3' + id +
                     '" class="product-name"><a href="' + url + '">' + name + '</a></td> <td id="delete_trall4' +
                     id + '" class="product-price"><span class="amount">' + price +
                     '</span></td><td class="product-stock-status"><span>{{ trans('home.INSTOCK') }}</span></td><td id="delete_trall5' +
                     id + '" class="product-add-to-cart"><a href="' + url +
     ...
     function add_wishList(clicked_id) {
        ...
        `);
             $('#sidbar_product').append('<div class="single-product" id="del_product' + id +
                 '"><div class="pro-img"><a href="' + url + '"><img style="height:150px" class="primary-img" src="' +
                 image +
                 '" alt="single-product"></a></div><div class="pro-content"><div class="pro-info"><h4><a href="' +
                 url + '">' + name + '</a></h4><p><span class="price">' + price +
                 '</span></p></div><div class="pro-actions"><div class="actions-primary"><a href="' + url +
             ...
             $('#product_wishlist').append('<tr id="delete_trall' + id +
                 '" ><td class="product-remove"><a style="cursor: pointer;" onclick="del_wishList(' + id +
                 ')" title="Remove"><i class="fa fa-times" aria-hidden="true"></i></a></td><td class="product-thumbnail"><a href="#"><img src="' +
                 image + '" alt="cart-image" /></a></td><td class="product-name"><a href="' + url + '">' + name +
                 '</a></td> <td class="product-price"><span class="amount">' + price +
                 '</span></td><td class="product-stock-status"><span>{{ trans('home.INSTOCK') }}</span></td><td class="product-add-to-cart"><a href="' +
                 url + '">{{ trans('home.addcart') }}</a></td></tr>');
