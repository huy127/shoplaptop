                ...
                <ul>
                    <li><span>{{ trans('home.lang_1') }}:</span> <a href="#">
                            @if (config('app.locale') != 'en')
                                <img src="{{ asset('source/assets/dest/img/vn.png') }}" width="16px"
                                    alt="language-selector">
                            @else
                                <img src="{{ asset('source/assets/frontend/img/header/1.jpg') }}"
                                    alt="language-selector">
                            @endif
                        ...
                        <ul class="ht-dropdown">
                            <li><a href="{{ URL::asset('') }}language/vi"><img
                                        src="{{ asset('source/assets/dest/img/vn.png') }}" width="16px"
                                        alt="language-selector">{{ trans('home.languagevi') }}</a></li>
                            <li><a href="{{ URL::asset('') }}language/en"><img
                                        src="{{ asset('source/assets/frontend/img/header/1.jpg') }}"
                                        alt="language-selector">{{ trans('home.languageen') }}</a></li>
            ...
            <div class="row align-items-center no-gutters">
                <div class="col-lg-3 col-md-12">
                    <div class="logo mb-all-30">
                        <a href="{{ route('trang-chu') }}"><img
                                src="{{ asset('source/assets/dest/images/logo-laptop.png') }}"
                                style="width: 214px; height: 162px" alt="logo-image"></a>
                    </div>
                </div>
                <!-- Categorie Search Box Start Here -->
                <div class="col-lg-5 col-md-8 ml-auto mr-auto col-10">
                    <div class="categorie-search-box">
                        <form role="search" method="post" id="searchform" action="{{ route('timkiem') }}"
                            onsubmit="return validate()" autocomplete="off">
                            @csrf
                            <input id="key" type="text" name="search"
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="cart-box mt-all-30">
                        <ul class="d-flex justify-content-lg-end justify-content-center align-items-center">
                                        ...
                                        <li>
                                            @foreach ($product_cart as $poroduct)
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="#"><img
                                                                src="source/image/product/{{$poroduct['item']['image'] }}"
                                                                alt="cart-image"></a>
                                                        <span class="pro-quantity">{{ $poroduct['qty'] }}X</span>
                                                    </div>
                                                    <div class="cart-content">
                                                        <h6><a href="product.html">{{ $poroduct['item']->$multisp }}
                                                            </a></h6>
                                                        <span class="cart-price">
                                                            @if ($poroduct['item']['promotion_price'] == 0)
                                                                {{ number_format($poroduct['item']['unit_price']) }}
                                                                VNĐ
                                                            @else
                                                                {{ number_format($poroduct['item']['promotion_price']) }}
                                                                VNĐ
                                                            @endif
                                                        </span>
                                                    </div>
                                                    <a class="del-icone"
                                                        href="{{ route('xoagiohang', $poroduct['item']['id']) }}"><i
                                                            class="ion-close"></i></a>
                                                </div>
                                                <!-- Cart Box End -->
                                            @endforeach
                                            ...
                                            <div class="cart-footer">
                                                <div class="cart-actions text-center">
                                                    <a class="cart-checkout"
                                                        href="{{ route('shoppingcart') }}">{{ trans('home.chitiet') }}</a>
                                                </div>
                                            </div>
                            ...
                            @else
                                <li><a href="{{ route('dangnhap') }}"><i class="lnr lnr-user"></i><span
                                            class="my-cart"><span> <strong>{{ trans('home.signin') }}</strong>
                                                Or</span><span> {{ trans('home.signup') }}</span></span></a>
    ...
    <div class="header-bottom  header-sticky">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-2 col-lg-4 col-md-6 vertical-menu d-none d-lg-block">
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 ">
                    <nav class="d-none d-lg-block">
                        <ul class="header-bottom-list d-flex">
                            ...
                            @if ($url_canonical == route('allproduct'))
                                <li class="active"><a
                                        href="{{ route('allproduct') }}">{{ trans('home.producttt') }}<i
                                    ...
                                    <ul class="ht-dropdown">
                                        @foreach ($loai_sanpham as $lsp)
                                            <li>
                                                <a
                                                    href="{{ route('loaisanpham', $lsp->id) }}">{{ $lsp->name_type }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                            ...
                            @else
                                <li><a href="{{ route('allproduct') }}">{{ trans('home.producttt') }}<i
                                            class="fa fa-angle-down"></i></a>
                                    <!-- Home Version Dropdown Start -->
                                    <ul class="ht-dropdown">
                                        @foreach ($loai_sanpham as $lsp)
                            ...
                            @if ($url_canonical == route('gioithieu'))
                                <li class="active"><a href="{{ route('gioithieu') }}">{{ trans('home.about') }}</a>
                                </li>
                            @else
                                <li><a href="{{ route('gioithieu') }}">{{ trans('home.about') }}</a></li>
                            @endif
                            @if ($url_canonical == route('lienhe'))
                                <li class="active"><a href="{{ route('lienhe') }}">{{ trans('home.contact') }}</a>
                                </li>
                            @else
                    ...
                    <div class="mobile-menu d-block d-lg-none">
                        <nav>
                            <ul>
                                <li><a href="{{ route('trang-chu') }}">homeeee</a>
                                </li>
                ...
                <div id="cate-mobile-toggle"
                    ...
                    <ul>
                        @foreach ($loai_sanpham as $sl)
                            <li class="has-sub"><a href="{{ route('loaisanpham', $sl->id) }}">Laptop
                                    {{ $sl->name_type }}</a></li>
                        @endforeach
                    </ul>
                </div>
